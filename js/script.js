    ...
    const translations = {
      ...
      'about-p': ['تهدف حملة "نحو حرم جامعي أخضر" إلى تعزيز الوعي البيئي بين الطلاب من خلال نظام سلات ذكية لفرز النفايات.',
                  'The "Towards a Green University Campus" campaign aims to raise environmental awareness among students through a smart waste sorting system.'],
      ...
      'how-p': ['تفتح السلة باستخدام البطاقة الجامعية، ويُحسب الوزن داخل السلة ليضاف إلى رصيد الطالب كنقاط.',
                'The bin opens with the student card, and the weight inside is added to the student\'s points.'],
      'points-h2': ['نظام النقاط والمكافآت', 'Points and Rewards System'],
      'points-p': ['يمكن للطالب استبدال النقاط بمكافآت مثل وجبات كافتيريا، استعارة كتب أو بطاقات خصم في متجر الجامعة.',
                   'Students can redeem points for rewards like cafeteria meals, borrowing books, or discount cards in the campus store.'],
      'monitoring-h2': ['المراقبة والعقوبات', 'Monitoring and Penalties'],
      'monitoring-p': ['توجد كاميرات مراقبة على السلات لضمان الاستخدام السليم، مع فرض عقوبات على المخالفين.',
                       'CCTV cameras are installed on bins to ensure proper use, with penalties for violators.'],
      'section-buttons': [['عن الحملة','أهداف الحملة','كيف تعمل السلات','نظام النقاط','المراقبة'],
                          ['About','Goals','How It Works','Points','Monitoring']]
    };
